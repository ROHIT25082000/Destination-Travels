...
def call_admin():
    ...
    for i in range(3):
        if(name == "postgres" and password == "postgres"):
            ...
            name = input("Enter the admin usersname again :")
            password = input("Enter the admin password again :")
        ...
        if current_obj != None and current_session_obj != None:
            ...
            if(True):
                ...
                if(row == []):
                    ...
                    print()
                    print("Driver fname     : "+str(row[0][0]))
                    print("Driver lname     : "+str(row[0][1]))
                    print("Driver cab_name  : "+str(row[0][2]))
                    print("Driver cab_type  : "+str(row[0][3]))
                    print("Driver cab_no    : "+str(row[0][4]))
                    print("Ride Fare        : "+"Rs."+str(ride_fee))
                    ...
                    for i in range(3):
                        ...
                        if(resp_otp == ride_otp):
                            ...
                            sql = """
                            UPDATE wallet 
                            set balance = """+str(balance_new)+" where wallet_id ="+str(current_obj.wallet_id)
                            cursor.execute(sql)
